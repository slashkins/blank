...
Как использовать: кидаем Skill Swap, затем Bestow. Теперь у покемона-соперника есть Леппа-ягода и абилка Хавест (50% шанс в конце хотя найти ягодку, которую он съел).
